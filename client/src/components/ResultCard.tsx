...
export default function ResultCard({ result, onBlendAgain }: ResultCardProps) {
  ...
  const generateSummaryCanvas = async (): Promise<HTMLCanvasElement | null> => {
    return new Promise((resolve) => {
      ...
      img.onload = () => {
        ...
        ctx.drawImage(img, imgX, yPos, imgWidth, imgHeight);
  ...
  const downloadSummaryPNG = async () => {
    ...
    toast({
      ...
      description: "Your drink summary PNG has been saved.",
      duration: 3000,
    });
  };
  ...
  const handleDownloadCard = async () => {
    ...
    try {
      ...
      const link = document.createElement("a");
      link.href = await html2canvas(cardRef.current, {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto animate-fade-in">
      ...
      {showSummary && summaryImage && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50 backdrop-blur-sm">
          <Card className="w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-background">
            <div className="flex items-center justify-between p-4 md:p-6 border-b border-border sticky top-0">
              <h2 className="text-lg md:text-xl font-bold font-['Montserrat'] text-foreground">
                Your Drink Summary
              </h2>
              <button
